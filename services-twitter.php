...
$message = '';
$platform = 'Twitter'; // Easily change this variable for other platform files
        ...
        <?php if (count($platformServices) > 0): ?>
            <div class="row g-4 mt-3">
                <?php foreach ($platformServices as $service): ?>
                    <div class="col-md-4">
                        <div class="p-4 rounded shadow-lg bg-dark text-white">
                            ...
                            <button type="button" class="btn btn-primary mt-2 w-100" data-bs-toggle="modal" data-bs-target="#orderModal-<?= $service['id']; ?>">
                                Place Order
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                <form method="POST">
                                    ...
                                    <div class="modal-body text-dark">
                                        ...
                                        <div class="mb-3">
                                            <label for="target_link" class="form-label"><?= htmlspecialchars($platform); ?> Post/Profile Link</label>
