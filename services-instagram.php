...
$message = '';
$platform = 'Instagram'; // Easily change this variable for other platform files

// --- Logic to Handle Order Submission (Same as other services) ---
        ...
        <?php if (count($platformServices) > 0): ?>
            <div class="row g-4 mt-3">
                <?php foreach ($platformServices as $service): ?>
                    <div class="col-md-4">
                        <div class="p-4 rounded shadow-lg bg-danger text-white">
