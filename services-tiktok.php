<?php
// services-tiktok.php (Template for other platforms)
...
$message = '';
$platform = 'TikTok'; // Easily change this variable for other platform files

// --- Logic to Handle Order Submission (Same as services-youtube.php) ---
                            ...
                            <div class="modal-content">
                                <form method="POST">
                                    ...
                                    <div class="modal-body text-dark">
                                        ...
                                        <div class="mb-3">
                                            <label for="target_link" class="form-label"><?= htmlspecialchars($platform); ?> Video/Profile Link</label>
